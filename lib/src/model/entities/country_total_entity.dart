...
List<CountryTotal> countryTotalFromJson(String str) => List<CountryTotal>.from(json.decode(str).map((x) => CountryTotal.fromJson(x)));

String countryTotalToJson(List<CountryTotal> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
